...
/**
  * Body of a post to /run/formula to test or run a formula If save is set to true, user must be the same as current user  Cannot set value for both a document unid and a dql query
 **/
...
public class FormulaRequest  {
 ...
 /**
   * UniqueId of a document to test against. Can be empty if formula doesn't rely on fields in a document
  **/
  @JsonbProperty("unid")
  private String unid;
