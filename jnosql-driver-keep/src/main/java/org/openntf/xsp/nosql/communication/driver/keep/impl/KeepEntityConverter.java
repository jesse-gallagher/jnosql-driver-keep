...
public class KeepEntityConverter extends AbstractEntityConverter {
	...
	public Stream<DocumentEntity> convertDocuments(String entityName, List<Map<String, Object>> docs, ClassMapping classMapping) {
		return docs.stream()
			.map(doc -> {
				@SuppressWarnings("unchecked")
				Map<String, Object> meta = (Map<String, Object>)doc.get("@meta"); //$NON-NLS-1$
				String id = (String)meta.get("unid"); //$NON-NLS-1$
	...
	public Map<String, Object> convertNoSQLEntity(DocumentEntity entity, boolean inserting, ClassMapping classMapping) {
