...
/**
  * Query and constraints for a DQL query to Domino. If not passing property 'mode', it will search from mode 'dql'. 
 **/
...
public class QueryRequest  {
 ...
 /**
   * This is form mode configured in Keep Database. If no mode has been passed, it will use default \"dql\". 
  **/
  @JsonbProperty("mode")
  private String mode;

 /**
   * List of form names to be added to the query. KEEP will lookup all potential alias values and add them to the query clause
  **/
  @JsonbProperty("forms")
