...
/**
  * Provides information of access level required for Domino REST API operations: - Domino REST API mapping in Domino directory - Domino REST API configuration in individual databases  Masks ACL and Role checks for users of the API
 **/
