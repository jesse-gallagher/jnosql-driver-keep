...
public class KeepAccessDetail  {
 ...
 /**
   * Can the given user read existing KEEP configurations
  **/
  @JsonbProperty("readKeepConfig")
  private Boolean readKeepConfig;

 /**
   * Can the current user create or delete KEEP configurations
  **/
  @JsonbProperty("createDeleteKeepConfig")
  private Boolean createDeleteKeepConfig;

 /**
   * List of KEEP configurations, ready to be mapped, in the design of a database
  **/
  ...
  **/
  ...
  public KeepAccessDetail configurations(List<String> configurations) {
    this.configurations = configurations;
    return this;
  }

  public KeepAccessDetail addConfigurationsItem(String configurationsItem) {
