...
public class RestConfigShort  {
 ...
 /**
   * When notes database has been configured \"Inherit from the design template\", if \"Prohibit design refresh or replace to modify\" is checked, the design element will not be affected when you replace or refresh the design.
  **/
