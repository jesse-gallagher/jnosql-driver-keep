...
public class OAuthApplicationResponse  {
  ...
  **/
  ...
  public enum TokenEndpointAuthMethodEnum {
    ...
    public static final class Deserializer implements JsonbDeserializer<TokenEndpointAuthMethodEnum> {
        @Override
        public TokenEndpointAuthMethodEnum deserialize(JsonParser parser, DeserializationContext ctx, Type rtType) {
    ...
    public static final class Serializer implements JsonbSerializer<TokenEndpointAuthMethodEnum> {
        @Override
        public void serialize(TokenEndpointAuthMethodEnum obj, JsonGenerator generator, SerializationContext ctx) {
  ...
  **/
  ...
  public OAuthApplicationResponse tokenEndpointAuthMethod(TokenEndpointAuthMethodEnum tokenEndpointAuthMethod) {
    this.tokenEndpointAuthMethod = tokenEndpointAuthMethod;
    return this;
  }
