...
public interface CodeApi  {
    ...
    StatusMessage cancelAgent(@QueryParam("dataSource") @NotNull String dataSource, @PathParam("uuid") String uuid) throws ApiException, ProcessingException;
    ...
    @Produces({ "application/json" })
    ExecutionResult execute(@QueryParam("dataSource") @NotNull String dataSource, @Valid ExecutionRequest executionRequest) throws ApiException, ProcessingException;

    /**
     * Runs an agent in a database, in real time
     *
     * Runs an existing agent, serverside. Existing limits of agent execution duration apply. This should only be used for short-running agents and simulated calling the agent from a browser    Formula type agent&#39;s target is anything other than \&quot;None\&quot; is unsupported trigger.    Unsupported trigger will get \&quot;Unsupported trigger and search in the background or embedded agent\&quot;
     *
     */
    @POST
    @Path("/agent")
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    Object executeAgent(@QueryParam("dataSource") @NotNull String dataSource, @Valid AgentPayload agentPayload) throws ApiException, ProcessingException;
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    StatusMessage executeAgentAsync(@QueryParam("dataSource") @NotNull String dataSource, @Valid AgentPayloadAsync agentPayloadAsync) throws ApiException, ProcessingException;
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    Object executeAgentWithContext(@QueryParam("dataSource") @NotNull String dataSource, @Valid AgentWithContextMessage agentWithContextMessage) throws ApiException, ProcessingException;
    ...
    @Produces({ "application/json" })
    ExecutionResult executeGroovy(@QueryParam("dataSource") @NotNull String dataSource, @Valid String body, @QueryParam("collection") String collection, @QueryParam("document") String document, @QueryParam("view") String view, @QueryParam("query") String query) throws ApiException, ProcessingException;
    ...
    @Consumes({ "text/plain" })
    @Produces({ "application/json" })
    ExecutionResult executeJavaScript(@QueryParam("dataSource") @NotNull String dataSource, @Valid String body, @QueryParam("collection") String collection, @QueryParam("document") String document, @QueryParam("view") String view, @QueryParam("query") String query) throws ApiException, ProcessingException;
    ...
    @Path("/agentAsync/{uuid}")
    @Produces({ "application/json" })
    AgentAsyncMessage getAgentInfo(@QueryParam("dataSource") @NotNull String dataSource, @PathParam("uuid") String uuid) throws ApiException, ProcessingException;

    /**
     * Post a formula  to Domino
     *
     * Checks if a formula would execute properly. Mostly used for Domino REST API AdminUI to test formula fields
     *
     */
    @POST
    @Path("/formula")
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    FormulaResult runFormula(@QueryParam("dataSource") @NotNull String dataSource, @Valid FormulaRequest formulaRequest) throws ApiException, ProcessingException;
}
