...
/**
  * Configuration of a keep database including views, forms, agents, modes. Used only for admin endpoints.
 **/
...
public class KeepDatabase  {
 ...
 /**
   * All forms that are configured for access via the KEEP API. Details in keepdatabaseconfig_formmode
  **/
 ...
 /**
   * Array of Views that are available in the Keep API 
  **/
  @JsonbProperty("views")
