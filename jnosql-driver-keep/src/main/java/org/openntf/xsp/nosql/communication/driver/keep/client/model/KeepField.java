  ...
  **/
  ...
  public enum FieldAccessEnum {
    ...
    public static final class Deserializer implements JsonbDeserializer<FieldAccessEnum> {
        @Override
        public FieldAccessEnum deserialize(JsonParser parser, DeserializationContext ctx, Type rtType) {
    ...
    public static final class Serializer implements JsonbSerializer<FieldAccessEnum> {
        @Override
        public void serialize(FieldAccessEnum obj, JsonGenerator generator, SerializationContext ctx) {
            generator.write(obj.value);
        }
    }
  }
