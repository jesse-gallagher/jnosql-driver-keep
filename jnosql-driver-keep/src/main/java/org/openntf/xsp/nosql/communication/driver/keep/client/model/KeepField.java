...
/**
  * Field description for fields / items in a KeepFormMode. Describes name, type, and multi-value capability. Modeled after json-schema where multi-value = array extension to json-schema limited to x-access-name to specify DOmino Names, Reader, Author nature All other field copied from JSON Schema
 **/

public class KeepField  {
  
 /**
   * Field name. While anything theoretical is possible we stick to letters and numbers with the first letter capitalized. Not a hard rule to accomodate existing data
  **/
  @JsonbProperty("name")
  private String name;
  ...
  public enum TypeEnum {
    ...
    OBJECT(String.valueOf("object")), ARRAY(String.valueOf("array")), STRING(String.valueOf("string")), NUMBER(String.valueOf("number")), INTEGER(String.valueOf("integer")), BOOLEAN(String.valueOf("boolean"));
 ...
 /**
   * Domino multi-value fields can be grouped together to form a kind oc child record in a document. The fieldGroup defines such a grouping. It only is relevant for multi-value fields and isn't populated by default
  **/
  ...
  **/
  ...
  public enum FormatEnum {
    ...
    AUTHORS(String.valueOf("authors")), BINARY(String.valueOf("binary")), BYTE(String.valueOf("byte")), DATE(String.valueOf("date")), DATE_TIME(String.valueOf("date-time")), DOUBLE(String.valueOf("double")), FLOAT(String.valueOf("float")), INT32(String.valueOf("int32")), INT64(String.valueOf("int64")), NAMES(String.valueOf("names")), PASSWORD(String.valueOf("password")), READERS(String.valueOf("readers")), RICHTEXT(String.valueOf("richtext")), BOOLEAN(String.valueOf("boolean")), STRING(String.valueOf("string")), JSON(String.valueOf("json")), ATTACHMENTS(String.valueOf("attachments"));
 ...
 /**
   * Field can be read, but not updated. Can only be true if writeOnly is false
  **/
  @JsonbProperty("readOnly")
  private Boolean readOnly;

 /**
   * Field can be updated, but not read (Postbox / VoteBox style). Can only be true if readOnly is false
  **/
  @JsonbProperty("writeOnly")
  ...
  **/
  ...
  public KeepField multivalue(Boolean multivalue) {
    this.multivalue = multivalue;
    return this;
  }
  ...
  **/
  ...
  public KeepField readOnly(Boolean readOnly) {
    this.readOnly = readOnly;
    return this;
  }
  ...
  **/
  ...
  public KeepField writeOnly(Boolean writeOnly) {
    this.writeOnly = writeOnly;
    return this;
  }
