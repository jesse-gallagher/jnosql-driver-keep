...
/**
  * Runs an existing agent in a given database using a specific document as the agent's run context. The is the status message of the response.
 **/
...
public class AgentWithContextMessage  {
 ...
 /**
   * The UNID of a document to passing by. NotesSession.documentContext can be used in the agent to access the relevant document. 
  **/
  @JsonbProperty("unid")
  private String unid;

 /**
   * The mode configured in Keep. 
  **/
