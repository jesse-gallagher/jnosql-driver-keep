...
public interface ScopeApi  {
    ...
    KeepForm fetchFormModes(@QueryParam("dataSource") @NotNull String dataSource, @PathParam("form") String form, @PathParam("mode") String mode) throws ApiException, ProcessingException;
    ...
    @Path("/scopes")
    @Produces({ "application/json" })
    List<KeepDBShort> fetchScopes(@QueryParam("includeAll") Boolean includeAll, @QueryParam("skipIcon") Boolean skipIcon) throws ApiException, ProcessingException;
    ...
    @Path("/scope")
    @Produces({ "application/json" })
    KeepDatabase getScope(@QueryParam("dataSource") @NotNull String dataSource) throws ApiException, ProcessingException;
    ...
    @Produces({ "application/json" })
    KeepForm getScopeForm(@QueryParam("dataSource") @NotNull String dataSource, @PathParam("form") String form) throws ApiException, ProcessingException;
}
