...
public class ListDesignItem  {
 ...
 /**
   * true = it is a folder where user interaction or code determines the content false = it is a view with a fixed query, a.k.a View selection formula
  **/
  ...
  **/
  ...
  private List<ListDesignColumn> columns = null;
 ...
 /**
   ...
   * @return columns
  **/
  public List<ListDesignColumn> getColumns() {
    return columns;
  }
  ...
  /**
    * Set columns
  **/
  public void setColumns(List<ListDesignColumn> columns) {
    this.columns = columns;
  }

  public ListDesignItem columns(List<ListDesignColumn> columns) {
    this.columns = columns;
    return this;
  }

  public ListDesignItem addColumnsItem(ListDesignColumn columnsItem) {
